...
class Translation(object):
    def __init__(self,master):
        ...
        self.languages={
            'Arabic':'ar','Belarusian':'be','Bulgarian':'bg','Bosnian':'bs','Czech':'cs','Danish':'da','German':'de','Greek':'el',
            'English':'en','Spanish':'es','Persian':'fa','Finnish':'fi','French':'fr','Irish':'ga','Hebrew':'he','Hindi':'hi',
            'Croatian':'hr','Haitian':'ht','Hungarian':'hu','Armenian':'hy','Indonesian':'id','Italian':'it','Japanese':'ja',
            'Korean':'ko','Kurdish':'ku','Latin':'la','Lithuanian':'lt','Latvian':'lv','Dutch':'nl','Norwegian':'no',
            'Polish':'pl','Portuguese':'pt','Romanian':'ro','Russian':'ru','Somalia':'so','Albanian':'sq','Serbian':'sr',
            'Swedish':'sr','Swahili':'sw','Turkish':'tr','Vietnamese':'vi'
        }
        self.translate_page()
        self.about_page()
    ...
    def translate_page(self):
        ...
        self.translate_button=Button(self.translate_tab,text="Translate!",command=self.translation)
